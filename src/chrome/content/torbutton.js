    ...
    if (aFlag & Components.interfaces.nsIWebProgressListener.STATE_STOP) {
      ...
      m_tb_resize_handler = function() {
        if (window.windowState === 1) {
          if (m_tb_prefs.
              getIntPref("extensions.torbutton.maximize_earning_counter") < 3) {
            let sb = torbutton_get_stringbundle();
            ...
            let buttons = [{
              ...
              callback:
                function() {
                  m_tb_prefs.setIntPref("extensions.torbutton.maximize_earning_counter",
                  m_tb_prefs.getIntPref("extensions.torbutton.maximize_earning_counter") + 1);
                }
            }];
